...
public class IlluminaGenome extends Script {

	public IlluminaGenome(ProjectManager pm) {
		super(pm);
		scriptFile = "submit_wgs.sh";
		...
		arguments.put("Skip BAM/VCF merging stage", " -w");
		...
		compatibleAnalysis.add("genomes_haplotype_caller");
	}
