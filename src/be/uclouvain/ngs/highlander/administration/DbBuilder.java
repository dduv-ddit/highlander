...
public class DbBuilder {
	...
	public static void addextlinks() throws Exception {
		...
		if (!existingLinks.contains("AlphaMissense")) new ExternalLink("AlphaMissense", "AlphaMissense spot mutations", "https://alphamissense.hegelab.org/hotspot?uid=[transcript_uniprot_id]&resi=[protein_pos]","").insert(Highlander.class.getResourceAsStream("resources/ext_alphamissense.png"));
		...
		if (!existingLinks.contains("gnomAD")) {
			...
			Highlander.getDB().update(Schema.HIGHLANDER, "UPDATE `external_links` SET `url_genome` = 'GRCh37=r2_1;hg19=r2_1;b37=r2_1;b37_decoy=r2_1;GRCh38=r4;hg19_lifescope=r2_1' WHERE `name` = 'gnomAD'");		}
		...
		if (!existingLinks.contains("OMIM")) new ExternalLink("OMIM", "Gene in OMIM", "https://omim.org/search?index=entry&start=1&limit=10&sort=score+desc%2C+prefix_sort+desc&search=","[gene_symbol]").insert(Highlander.class.getResourceAsStream("resources/ext_omim.png"));
